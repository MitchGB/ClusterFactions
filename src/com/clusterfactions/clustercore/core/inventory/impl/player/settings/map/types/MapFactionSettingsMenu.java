...
public class MapFactionSettingsMenu extends InventoryBase{

	public MapFactionSettingsMenu(Player player) {
		super(player, "MAP_FACTION_MENU_SETTINGS", "&f" + CharRepo.MENU_CONTAINER_27, 27);
		...
		for(MapColour colour : MapColour.values())
		{
			this.addItem(new ItemBuilder(Material.WHITE_WOOL).coloredName(colour.toString()).coloredLore("Click me to choose colour").create(), e -> {
				playerData.setMapFactionColour(colour);
				playerData.saveData("mapFactionColour");
