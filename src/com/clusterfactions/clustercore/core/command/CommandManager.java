...
public class CommandManager {
	...
	public List<String> allCommands(BaseCommand commandClass){
        try {
        	List<String> ret = new ArrayList<>();
            Class<? extends BaseCommand> clazz = commandClass.getClass();
        	String mainCommand = clazz.getAnnotation(CommandAlias.class).value().split("|")[0];
